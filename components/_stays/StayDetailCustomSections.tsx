...
import { useStayDetailSections } from '@/hooks/useStays';
import { motion, AnimatePresence } from 'framer-motion';
import { ChevronDown, ArrowRight, HelpCircle } from 'lucide-react';
import Link from 'next/link';

type Props = { staySlug: string };

export const StayDetailCustomSections = ({ staySlug }: Props) => {
  const { data: sectionsData, isLoading } = useStayDetailSections(staySlug);
