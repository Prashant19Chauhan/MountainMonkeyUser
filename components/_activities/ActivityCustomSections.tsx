...
import { useActivitiesPageSections } from '@/hooks/useActivities';
import { motion, AnimatePresence } from 'framer-motion';
import { ChevronDown, ArrowRight, HelpCircle } from 'lucide-react';
import Link from 'next/link';

export const ActivityCustomSections = () => {
  const { data: pageContent, isLoading } = useActivitiesPageSections();
