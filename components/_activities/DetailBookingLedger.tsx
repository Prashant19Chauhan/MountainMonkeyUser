...
export const DetailBookingLedger = ({ basePrice }: DetailBookingLedgerProps) => {
    ...
    <div className="lg:sticky lg:top-8">
      <div className="bg-white border border-slate-200 shadow-xl rounded-2xl p-6 space-y-5">
        <div className="flex justify-between items-baseline">
          <div>
            <span className="text-[10px] text-slate-400 block font-bold uppercase tracking-wider">Dynamic Invoiced Pass</span>
            <span className="text-3xl font-black text-slate-900">₹{basePrice * pax}</span>
          </div>
          <span className="text-[11px] font-bold text-emerald-600 bg-emerald-50 border border-emerald-100 px-2.5 py-1 rounded-lg flex items-center gap-0.5">
