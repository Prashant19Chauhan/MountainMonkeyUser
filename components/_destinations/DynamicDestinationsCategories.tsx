          ...
          >
            ...
            >
              {cat.list.map((dest: Destination, index: number) => {
                ...
                switch (cat.id) {
                  // ==========================================
                  // 1. TRENDING SPOTLIGHT CARD DESIGN
                  // ==========================================
                  case 'trending': {
                    return (
                      <div
                        ...
                        <div className="absolute bottom-6 left-6 text-white right-6">
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <span className="flex items-center gap-1 text-[10px] font-black text-yellow-400">
                              <Star size={11} className="fill-yellow-400" /> {dest.ratings?.average || "4.8"}
                            </span>
                          </div>
                        </div>
                      </div>
                  ...
                  // ==========================================
                  // 2. ADVENTURE CARD DESIGN (3D SKEW ON HOVER)
                  // ==========================================
                  case 'adventure': {
                    return (
                      <motion.div
                  ...
                  // ==========================================
                  // 3. HISTORICAL CARD DESIGN (SERIF PARCHMENT)
                  // ==========================================
                  case 'history': {
                    return (
                      <motion.div
                  ...
                  // ==========================================
                  // 4. TROPICAL CARD DESIGN (SUNBURST RIPPLE)
                  // ==========================================
                  case 'tropical': {
                    return (
                      <div
                  ...
                  // ==========================================
                  // 5. NATURE CARD DESIGN (EMERALD PULSE)
                  // ==========================================
                  case 'nature': {
                    return (
                      <div
                  ...
                  // ==========================================
                  // 6. SPIRITUAL CARD DESIGN (ZEN VIOLET BREATH)
                  // ==========================================
                  case 'spiritual': {
                    return (
                      <div
