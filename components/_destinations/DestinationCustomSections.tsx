...
import { useDestinationsPageSections } from '@/hooks/useDestinations';
import { motion, AnimatePresence } from 'framer-motion';
import { ChevronDown, ArrowRight, HelpCircle } from 'lucide-react';
import Link from 'next/link';

export const DestinationCustomSections = () => {
  const { data: pageContent, isLoading } = useDestinationsPageSections();
