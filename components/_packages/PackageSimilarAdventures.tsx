  ...
  return (
    <div className="max-w-8xl mx-auto px-4 md:px-12 lg:px-24 py-16 border-t border-gray-100">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {similarPackages.slice(0, 3).map((similarPackage: any) => (
              ...
              <div className="mt-auto flex justify-between items-end">
                <div>
                  ...
                  <span className="text-lg font-black text-gray-900">
                    ₹{similarPackage.pricing.basePrice.toLocaleString('en-IN')}
                  </span>
                </div>
                <div className="flex gap-3 text-xs text-gray-500">
                  <span className="flex items-center gap-1">
                    <Clock size={12}/> {similarPackage.duration.days} Days
                  </span>
                </div>
              </div>
            </div>
