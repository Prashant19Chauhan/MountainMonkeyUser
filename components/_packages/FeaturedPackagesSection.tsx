...
export const FeaturedPackagesSection = () => {
  ...
  return (
    <div ref={featuredRef} className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
      {isLoadingFeatured ? (
        <div className="lg:col-span-3 h-48 sm:h-[450px] flex justify-center items-center text-gray-400">
        ...
        <>
          ...
          >
            <div className="relative h-[220px] sm:h-[320px] lg:h-[450px]">
              <Image 
            ...
            <div className="p-5 sm:p-8">
              ...
              <h3 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">{featuredPackages[0]?.title || "Amazing Tour"}</h3>
              <div className="flex flex-wrap items-center gap-3 sm:gap-6 text-gray-400 text-sm mb-5 sm:mb-8 font-medium">
              ...
              <div className="flex justify-between items-end border-t border-gray-50 pt-4 sm:pt-6">
                <div>
                  ...
                  <div className="flex items-baseline gap-2">
                    <span className="text-2xl sm:text-3xl font-black text-gray-900">${featuredPackages[0]?.pricing?.basePrice || "899"}</span>
              ...
              return (
                ...
                >
                  ...
                  <div className="p-4 sm:p-6">
                    ...
                    <h4 className="font-bold text-gray-900 mb-1.5 sm:mb-2 truncate">{pkg.title || "Adventure Tour"}</h4>
                    <p className="text-xs text-gray-400 mb-3 sm:mb-4 flex items-center gap-1 font-medium">
                      <Clock size={14} /> {pkg.duration?.days || 5} Days
                    </p>
                    <div className="flex justify-between items-center">
                      <span className="text-lg sm:text-xl font-black text-gray-900">${pkg.pricing?.basePrice || 1450}</span>
