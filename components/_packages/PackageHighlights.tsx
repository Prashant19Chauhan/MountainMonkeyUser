    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      <div className="bg-white p-4 rounded-2xl border border-gray-100 flex flex-col items-center justify-center text-center gap-2 shadow-sm">
        ...
        <div>
          ...
          <p className="text-sm font-bold text-gray-900">{packageDetails.duration.days} Days</p>
        </div>
      </div>
      <div className="bg-white p-4 rounded-2xl border border-gray-100 flex flex-col items-center justify-center text-center gap-2 shadow-sm">
      ...
      <div className="bg-white p-4 rounded-2xl border border-gray-100 flex flex-col items-center justify-center text-center gap-2 shadow-sm">
        ...
        <div>
          ...
          <p className="text-sm font-bold text-gray-900">Max {packageDetails.availability.maxSeats} Ppl</p>
        </div>
      </div>
    </div>
  );
